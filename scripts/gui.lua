...
local function build_entity_tab(_player_, _pdata_, tabbed, caption, set, _rows_, admin, is_global)
...
local function build_item_tab(_player_, _pdata_, tabbed, caption, _set_, _rows_, _adming_, _is_global_)
